...
import com.spyhunter99.supertooltips.exception.NoOverflowMenuRuntimeException;
import com.spyhunter99.supertooltips.exception.NoTitleViewRuntimeException;
...
public class ToolTipRelativeLayout extends RelativeLayout {
    ...
    public ToolTipView showToolTipForView(final ToolTip toolTip, final View view) {
        ...
        return setTooltip(toolTip, view, toolTipView);
    }
    ...
    private ToolTipView setTooltip(ToolTip toolTip, View view, ToolTipView toolTipView) {
        toolTipView.setToolTip(toolTip, view);
        return toolTipView;
    }

    public void addToolTipView(final ToolTipView toolTipView) {
        //FIXME, check to see if this already has a tooltip displayed, if so, close and destroy the old view
